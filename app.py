...
#     """Endpoint para registro con reconocimiento facial - DESHABILITADO"""
#     return jsonify({'success': False, 'message': 'Reconocimiento facial deshabilitado temporalmente'})
#     # try:
#     #     data = request.json
...
#     """Verificar solo el rostro sin necesidad de DNI - Login facial puro - DESHABILITADO"""
#     return jsonify({'success': False, 'message': 'Reconocimiento facial deshabilitado temporalmente'})


# @app.route('/api/check_face_registered', methods=['POST'])
# def api_check_face_registered():
#     """Verificar si un usuario ya tiene registro facial antes de registrar - DESHABILITADO"""
#     return jsonify({'success': False, 'message': 'Reconocimiento facial deshabilitado temporalmente'})
